...
$areaprof = $_POST['areaprof'];
$escolaprof = $_POST['escolaprof'];

$sqlprof = "INSERT INTO cadastroprof (fotoprof, nomeprof, cpfprof, senhaprof, areaprof, escolaprof) VALUES ('$fotoprof', '$nomeprof', 'cpfprof', $senhaprof','$areaprof', '$escolaprof')";

$salvarprof = mysqli_query($conexaoprof, $sqlprof);
...
<body>
	...
	<h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cadastroaluno.php"><input type="button" value="Aluno" class="btnaba"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cadastroprof.php"><input type="button" value="Professor" class="btnaba"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="cadastrolivro.php"><input type="button" value="Livro" class="btnaba"></a></h1>
			...
			<form method="post" action="processaluno.php">
				...
				Nome da Escola<br>
				<input type="text" name="escolaprof" class="campo" maxlength="40" required><br>
